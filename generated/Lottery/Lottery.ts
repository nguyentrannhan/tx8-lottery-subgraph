...
export class Lottery__viewLotteryResultValue0Struct extends ethereum.Tuple {
  ...
  get tx8PerBracket(): Array<BigInt> {
  ...
  get amountCollectedInTX8(): BigInt {
...
export class Lottery extends ethereum.SmartContract {
  ...
  maxpriceTicketInTX8(): BigInt {
    let result = super.call(
      "maxpriceTicketInTX8",
      "maxpriceTicketInTX8():(uint256)",
      []
    );
  ...
  try_maxpriceTicketInTX8(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "maxpriceTicketInTX8",
      "maxpriceTicketInTX8():(uint256)",
      []
  ...
  minpriceTicketInTX8(): BigInt {
    let result = super.call(
      "minpriceTicketInTX8",
      "minpriceTicketInTX8():(uint256)",
      []
    );
  ...
  try_minpriceTicketInTX8(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "minpriceTicketInTX8",
      "minpriceTicketInTX8():(uint256)",
      []
  ...
  tx8Token(): Address {
    let result = super.call("tx8Token", "tx8Token():(address)", []);

    return result[0].toAddress();
  }

  try_tx8Token(): ethereum.CallResult<Address> {
    let result = super.tryCall("tx8Token", "tx8Token():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
...
export class SetMinAndMaxTicketPriceInTX8Call extends ethereum.Call {
  get inputs(): SetMinAndMaxTicketPriceInTX8Call__Inputs {
    return new SetMinAndMaxTicketPriceInTX8Call__Inputs(this);
  }

  get outputs(): SetMinAndMaxTicketPriceInTX8Call__Outputs {
    return new SetMinAndMaxTicketPriceInTX8Call__Outputs(this);
  }
}

export class SetMinAndMaxTicketPriceInTX8Call__Inputs {
  _call: SetMinAndMaxTicketPriceInTX8Call;

  constructor(call: SetMinAndMaxTicketPriceInTX8Call) {
    this._call = call;
  }

  get _minpriceTicketInTX8(): BigInt {
    return this._call.inputValues[0].value.toBigInt();
  }

  get _maxpriceTicketInTX8(): BigInt {
    return this._call.inputValues[1].value.toBigInt();
  }
}

export class SetMinAndMaxTicketPriceInTX8Call__Outputs {
  _call: SetMinAndMaxTicketPriceInTX8Call;
